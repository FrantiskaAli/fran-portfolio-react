  ...
  return (
        ...
        <span id="turn"><i  className="fa-solid fa-rotate fa-2x"></i></span>
          ...
          <p id='intro'>
            ...
            Along with all this enthusiasm for web dev I am also mother of two beautiful girls so no time for other hobbies at the moment.<i className="fa-regular fa-face-laugh-wink fa-3x"></i>
          </p>
        </article>
